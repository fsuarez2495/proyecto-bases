...
async def register_user_firebase(user: UserRegister) -> dict:
    ...
    query = """
        INSERT INTO usuarios2 (correo_electronico, nombre, apellido)
        VALUES (:correo_electronico, :nombre, :apellido)
        RETURNING id_usuario, correo_electronico, nombre, apellido
            INTO :id_out, :correo_out, :nombre_out, :apellido_out
        """
    ...
    try:
        result_json = execute_query_json(query, params=params, needs_commit=True, returning_vars=returning_vars)
